...
/**
 * This is the item provider adapter for a {@link mymetamodel.PersistenceConfig} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersistenceConfigItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDbschemePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Dbscheme feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDbschemePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PersistenceConfig_dbscheme_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PersistenceConfig_dbscheme_feature", "_UI_PersistenceConfig_type"),
				 MymetamodelPackage.Literals.PERSISTENCE_CONFIG__DBSCHEME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MymetamodelPackage.Literals.PERSISTENCE_CONFIG__JDBC_USER_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
