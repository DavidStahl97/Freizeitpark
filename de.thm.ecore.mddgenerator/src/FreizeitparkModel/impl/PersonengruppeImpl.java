 ...
 * </p>
 * <ul>
 *   <li>{@link FreizeitparkModel.impl.PersonengruppeImpl#getTyp <em>Typ</em>}</li>
 *   <li>{@link FreizeitparkModel.impl.PersonengruppeImpl#getAnzahl <em>Anzahl</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonengruppeImpl extends MinimalEObjectImpl.Container implements Personengruppe {
	...
	protected EClass eStaticClass() {
		return FreizeitparkModelPackage.Literals.PERSONENGRUPPE;
	}
	...
	public void setTyp(String newTyp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FreizeitparkModelPackage.PERSONENGRUPPE__TYP, oldTyp, typ));
	}
	...
	public void setAnzahl(int newAnzahl) {
		...
		anzahl = newAnzahl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FreizeitparkModelPackage.PERSONENGRUPPE__ANZAHL, oldAnzahl, anzahl));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FreizeitparkModelPackage.PERSONENGRUPPE__TYP:
				return getTyp();
			case FreizeitparkModelPackage.PERSONENGRUPPE__ANZAHL:
				return getAnzahl();
		}
