 ...
 * </p>
 * <ul>
 *   <li>{@link FreizeitparkModel.impl.FahrgeschäftImpl#getMindestGröße <em>Mindest Größe</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FahrgeschäftImpl extends AttraktionImpl implements Fahrgeschäft {
	...
	protected EClass eStaticClass() {
		return FreizeitparkModelPackage.Literals.FAHRGESCHÄFT;
	}
	...
	public void setMindestGröße(double newMindestGröße) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FreizeitparkModelPackage.FAHRGESCHÄFT__MINDEST_GRÖSSE, oldMindestGröße, mindestGröße));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FreizeitparkModelPackage.FAHRGESCHÄFT__MINDEST_GRÖSSE:
