 ...
 *   <li>{@link FreizeitparkModel.impl.ThemenweltImpl#getVerkaufsLäden <em>Verkaufs Läden</em>}</li>
 *   <li>{@link FreizeitparkModel.impl.ThemenweltImpl#getÜbernachtungensmöglichkeiten <em>Übernachtungensmöglichkeiten</em>}</li>
...
public class ThemenweltImpl extends MinimalEObjectImpl.Container implements Themenwelt {
	...
	public EList<Verkaufsladen> getVerkaufsLäden() {
		if (verkaufsLäden == null) {
			verkaufsLäden = new EObjectContainmentEList<Verkaufsladen>(Verkaufsladen.class, this, FreizeitparkModelPackage.THEMENWELT__VERKAUFS_LÄDEN);
		}
	...
	public EList<Übernachtungsmöglichkeit> getÜbernachtungensmöglichkeiten() {
		if (übernachtungensmöglichkeiten == null) {
			übernachtungensmöglichkeiten = new EObjectContainmentEList<Übernachtungsmöglichkeit>(Übernachtungsmöglichkeit.class, this, FreizeitparkModelPackage.THEMENWELT__ÜBERNACHTUNGENSMÖGLICHKEITEN);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FreizeitparkModelPackage.THEMENWELT__VERKAUFS_LÄDEN:
				return ((InternalEList<?>)getVerkaufsLäden()).basicRemove(otherEnd, msgs);
			case FreizeitparkModelPackage.THEMENWELT__ÜBERNACHTUNGENSMÖGLICHKEITEN:
