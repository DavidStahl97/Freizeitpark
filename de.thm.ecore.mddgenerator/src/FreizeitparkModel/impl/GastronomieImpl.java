 ...
 * </p>
 * <ul>
 *   <li>{@link FreizeitparkModel.impl.GastronomieImpl#getAnzahlPlätze <em>Anzahl Plätze</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GastronomieImpl extends VerkaufsladenImpl implements Gastronomie {
	...
	protected EClass eStaticClass() {
		return FreizeitparkModelPackage.Literals.GASTRONOMIE;
	}
	...
	public void setAnzahlPlätze(int newAnzahlPlätze) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FreizeitparkModelPackage.GASTRONOMIE__ANZAHL_PLÄTZE, oldAnzahlPlätze, anzahlPlätze));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FreizeitparkModelPackage.GASTRONOMIE__ANZAHL_PLÄTZE:
