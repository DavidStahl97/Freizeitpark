 ...
 * </p>
 * <ul>
 *   <li>{@link FreitparkModel.impl.FreizeitparkImpl#getThemenWelten <em>Themen Welten</em>}</li>
 *   <li>{@link FreitparkModel.impl.FreizeitparkImpl#getName <em>Name</em>}</li>
 *   <li>{@link FreitparkModel.impl.FreizeitparkImpl#getDesign <em>Design</em>}</li>
 *   <li>{@link FreitparkModel.impl.FreizeitparkImpl#getEintrittskarten <em>Eintrittskarten</em>}</li>
 *   <li>{@link FreitparkModel.impl.FreizeitparkImpl#getAllgemeineInformationen <em>Allgemeine Informationen</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FreizeitparkImpl extends MinimalEObjectImpl.Container implements Freizeitpark {
	...
	protected EClass eStaticClass() {
		return FreitparkModelPackage.Literals.FREIZEITPARK;
	}
	...
	public EList<Themenwelt> getThemenWelten() {
		if (themenWelten == null) {
			themenWelten = new EObjectContainmentEList<Themenwelt>(Themenwelt.class, this, FreitparkModelPackage.FREIZEITPARK__THEMEN_WELTEN);
		}
		return themenWelten;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FreitparkModelPackage.FREIZEITPARK__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetDesign(Design newDesign, NotificationChain msgs) {
		...
		design = newDesign;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FreitparkModelPackage.FREIZEITPARK__DESIGN, oldDesign, newDesign);
	...
	public void setDesign(Design newDesign) {
		if (newDesign != design) {
			...
			if (design != null)
				msgs = ((InternalEObject)design).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FreitparkModelPackage.FREIZEITPARK__DESIGN, null, msgs);
			if (newDesign != null)
				msgs = ((InternalEObject)newDesign).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FreitparkModelPackage.FREIZEITPARK__DESIGN, null, msgs);
			msgs = basicSetDesign(newDesign, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FreitparkModelPackage.FREIZEITPARK__DESIGN, newDesign, newDesign));
	}
	...
	public EList<Eintrittskarte> getEintrittskarten() {
		if (eintrittskarten == null) {
			eintrittskarten = new EObjectContainmentEList<Eintrittskarte>(Eintrittskarte.class, this, FreitparkModelPackage.FREIZEITPARK__EINTRITTSKARTEN);
		}
	...
	public NotificationChain basicSetAllgemeineInformationen(AllgemeineInformationen newAllgemeineInformationen, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FreitparkModelPackage.FREIZEITPARK__ALLGEMEINE_INFORMATIONEN, oldAllgemeineInformationen, newAllgemeineInformationen);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAllgemeineInformationen(AllgemeineInformationen newAllgemeineInformationen) {
		if (newAllgemeineInformationen != allgemeineInformationen) {
			...
			if (allgemeineInformationen != null)
				msgs = ((InternalEObject)allgemeineInformationen).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FreitparkModelPackage.FREIZEITPARK__ALLGEMEINE_INFORMATIONEN, null, msgs);
			if (newAllgemeineInformationen != null)
				msgs = ((InternalEObject)newAllgemeineInformationen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FreitparkModelPackage.FREIZEITPARK__ALLGEMEINE_INFORMATIONEN, null, msgs);
			msgs = basicSetAllgemeineInformationen(newAllgemeineInformationen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FreitparkModelPackage.FREIZEITPARK__ALLGEMEINE_INFORMATIONEN, newAllgemeineInformationen, newAllgemeineInformationen));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FreitparkModelPackage.FREIZEITPARK__THEMEN_WELTEN:
				return ((InternalEList<?>)getThemenWelten()).basicRemove(otherEnd, msgs);
			case FreitparkModelPackage.FREIZEITPARK__DESIGN:
				return basicSetDesign(null, msgs);
			case FreitparkModelPackage.FREIZEITPARK__EINTRITTSKARTEN:
				return ((InternalEList<?>)getEintrittskarten()).basicRemove(otherEnd, msgs);
			case FreitparkModelPackage.FREIZEITPARK__ALLGEMEINE_INFORMATIONEN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FreitparkModelPackage.FREIZEITPARK__NAME:
				return getName();
			case FreitparkModelPackage.FREIZEITPARK__DESIGN:
				return getDesign();
			case FreitparkModelPackage.FREIZEITPARK__EINTRITTSKARTEN:
