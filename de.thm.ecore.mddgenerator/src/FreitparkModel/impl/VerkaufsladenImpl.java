 ...
 * </p>
 * <ul>
 *   <li>{@link FreitparkModel.impl.VerkaufsladenImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VerkaufsladenImpl extends MinimalEObjectImpl.Container implements Verkaufsladen {
	...
	protected EClass eStaticClass() {
		return FreitparkModelPackage.Literals.VERKAUFSLADEN;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FreitparkModelPackage.VERKAUFSLADEN__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FreitparkModelPackage.VERKAUFSLADEN__NAME:
				return getName();
		}
