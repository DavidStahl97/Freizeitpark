 ...
 * </p>
 * <ul>
 *   <li>{@link FreitparkModel.impl.AllgemeineInformationenImpl#getBeschreibung <em>Beschreibung</em>}</li>
 *   <li>{@link FreitparkModel.impl.AllgemeineInformationenImpl#getZeitplan <em>Zeitplan</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AllgemeineInformationenImpl extends MinimalEObjectImpl.Container implements AllgemeineInformationen {
	...
	protected EClass eStaticClass() {
		return FreitparkModelPackage.Literals.ALLGEMEINE_INFORMATIONEN;
	}
	...
	public void setBeschreibung(String newBeschreibung) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FreitparkModelPackage.ALLGEMEINE_INFORMATIONEN__BESCHREIBUNG, oldBeschreibung, beschreibung));
	}
	...
	public EList<Tag> getZeitplan() {
		if (zeitplan == null) {
			zeitplan = new EObjectContainmentEList<Tag>(Tag.class, this, FreitparkModelPackage.ALLGEMEINE_INFORMATIONEN__ZEITPLAN);
		}
		return zeitplan;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FreitparkModelPackage.ALLGEMEINE_INFORMATIONEN__ZEITPLAN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FreitparkModelPackage.ALLGEMEINE_INFORMATIONEN__BESCHREIBUNG:
