 ...
 * </p>
 * <ul>
 *   <li>{@link FreitparkModel.impl.HotelImpl#getSternBewertung <em>Stern Bewertung</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HotelImpl extends ÜbernachtungsmöglichkeitImpl implements Hotel {
	...
	protected EClass eStaticClass() {
		return FreitparkModelPackage.Literals.HOTEL;
	}
	...
	public void setSternBewertung(int newSternBewertung) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FreitparkModelPackage.HOTEL__STERN_BEWERTUNG, oldSternBewertung, sternBewertung));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FreitparkModelPackage.HOTEL__STERN_BEWERTUNG:
