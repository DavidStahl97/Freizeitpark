 ...
 * </p>
 * <ul>
 *   <li>{@link FreitparkModel.impl.RestaurantImpl#getSterneBewertung <em>Sterne Bewertung</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RestaurantImpl extends GastronomieImpl implements Restaurant {
	...
	protected EClass eStaticClass() {
		return FreitparkModelPackage.Literals.RESTAURANT;
	}
	...
	public void setSterneBewertung(int newSterneBewertung) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FreitparkModelPackage.RESTAURANT__STERNE_BEWERTUNG, oldSterneBewertung, sterneBewertung));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FreitparkModelPackage.RESTAURANT__STERNE_BEWERTUNG:
