 ...
 * </p>
 * <ul>
 *   <li>{@link mymetamodel.impl.RootConfigImpl#getPersistenceConfig <em>Persistence Config</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RootConfigImpl extends MinimalEObjectImpl.Container implements RootConfig {
	...
	protected EClass eStaticClass() {
		return MymetamodelPackage.Literals.ROOT_CONFIG;
	}
	...
	public NotificationChain basicSetPersistenceConfig(PersistenceConfig newPersistenceConfig, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MymetamodelPackage.ROOT_CONFIG__PERSISTENCE_CONFIG, oldPersistenceConfig, newPersistenceConfig);
	...
	public void setPersistenceConfig(PersistenceConfig newPersistenceConfig) {
		if (newPersistenceConfig != persistenceConfig) {
			...
			if (persistenceConfig != null)
				msgs = ((InternalEObject)persistenceConfig).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MymetamodelPackage.ROOT_CONFIG__PERSISTENCE_CONFIG, null, msgs);
			if (newPersistenceConfig != null)
				msgs = ((InternalEObject)newPersistenceConfig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MymetamodelPackage.ROOT_CONFIG__PERSISTENCE_CONFIG, null, msgs);
			msgs = basicSetPersistenceConfig(newPersistenceConfig, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MymetamodelPackage.ROOT_CONFIG__PERSISTENCE_CONFIG, newPersistenceConfig, newPersistenceConfig));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MymetamodelPackage.ROOT_CONFIG__PERSISTENCE_CONFIG:
